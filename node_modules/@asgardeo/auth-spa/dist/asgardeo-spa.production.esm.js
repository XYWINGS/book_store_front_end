...
/**
     ...
     *
     * @preserve
     */requestAccessToken(e,l,i,n){return t(this,void 0,void 0,(function*(){return(yield this._dataLayer.getTemporaryDataParameter("op_config_initiated"))?this._authenticationCore.requestAccessToken(e,l,i,n):this._authenticationCore.getOIDCProviderMetaData(!1).then((()=>this._authenticationCore.requestAccessToken(e,l,i,n)))}))}
/**
...
/**
     ...
     *
     * @preserve
     */static getInstance(e){var t,l;return e&&(null===(t=this._instances)||void 0===t?void 0:t.get(e))?this._instances.get(e):!e&&(null===(l=this._instances)||void 0===l?void 0:l.get(0))?this._instances.get(0):e?(this._instances.set(e,new cn(e)),this._instances.get(e)):(this._instances.set(0,new cn(0)),this._instances.get(0))}
/**
     ...
     *
     * @preserve
     */initialize(t,l,i){var n;return e(this,void 0,void 0,(function*(){if(this._storage=null!==(n=t.storage)&&void 0!==n?n:f.SessionStorage,this._initialized=!1,this._startedInitialize=!0,l&&this.instantiateAuthHelper(l),i&&this.instantiateWorker(i),this._storage!==f.WebWorker){if(!this._client){const e=t,l=Object.assign({},on);this._client=yield nn(this._instanceID,Object.assign(Object.assign({},l),e),((e,t)=>new this._authHelper(e,t)))}return this._initialized=!0,this._onInitialize&&this._onInitialize(!0),window.addEventListener("message",(e=>{var t;"refresh-access-token-error"===(null===(t=null==e?void 0:e.data)||void 0===t?void 0:t.type)&&this.signOut()})),Promise.resolve(!0)}if(!this._client){const e=t;return this._client=yield dn(this._instanceID,Object.assign(Object.assign({},on),e),this._worker,((e,t)=>new this._authHelper(e,t))),this._client.initialize().then((()=>(this._onInitialize&&this._onInitialize(!0),this._initialized=!0,Promise.resolve(!0)))).catch((e=>Promise.reject(e)))}return Promise.resolve(!0)}))}
/**
...
/**
     ...
     *
     * @preserve
     */signIn(t,l,i,n){var d;return e(this,void 0,void 0,(function*(){if(yield this._isInitialized(),F.canContinueSignIn(Boolean(null==t?void 0:t.callOnlyOnRedirect),l))return null==t||delete t.callOnlyOnRedirect,null===(d=this._client)||void 0===d?void 0:d.signIn(t,l,i,n).then((e=>(this._onSignInCallback&&(e.allowedScopes||e.displayName||e.email||e.username)&&this._onSignInCallback(e),e)))}))}trySignInSilently(){var t;return e(this,void 0,void 0,(function*(){if(yield this._isInitialized(),!F.wasSignInCalled())return null===(t=this._client)||void 0===t?void 0:t.trySignInSilently().then((e=>{if(this._onSignInCallback&&e){const t=e;(t.allowedScopes||t.displayName||t.email||t.username)&&this._onSignInCallback(t)}return e}))}))}
/**
...
/**
     ...
     *
     * @preserve
     */isSessionActive(){return e(this,void 0,void 0,(function*(){if(yield this._isInitialized(),this._storage&&[(f.WebWorker,f.BrowserMemory)].includes(this._storage))return Promise.reject(new X("SPA-AUTH_CLIENT-ISA-IV01","The active session cannot be returned.","The active session cannot be returned when the storage type is set to webWorker or browserMemory."));const e=this._client;return null==e?void 0:e.isSessionActive()}))}on(t,l,i){var n,d,o,c;return e(this,void 0,void 0,(function*(){if(yield this._isInitialized(),!l||"function"!=typeof l)throw new X("SPA-AUTH_CLIENT-ON-IV02","Invalid callback function.","The provided callback function is invalid.");switch(t){case U.SignIn:this._onSignInCallback=l;break;case U.SignOut:this._onSignOutCallback=l,(yield F.isSignOutSuccessful())&&this._onSignOutCallback();break;case U.RevokeAccessToken:this._onEndUserSession=l;break;case U.Initialize:this._onInitialize=l;break;case U.HttpRequestError:null===(n=this._client)||void 0===n||n.setHttpRequestErrorCallback(l);break;case U.HttpRequestFinish:null===(d=this._client)||void 0===d||d.setHttpRequestFinishCallback(l);break;case U.HttpRequestStart:null===(o=this._client)||void 0===o||o.setHttpRequestStartCallback(l);break;case U.HttpRequestSuccess:null===(c=this._client)||void 0===c||c.setHttpRequestSuccessCallback(l);break;case U.CustomGrant:i&&this._onCustomGrant.set(i,l);break;case U.SignOutFailed:{this._onSignOutFailedCallback=l;const e=F.didSignOutFail();e&&this._onSignOutFailedCallback(e);break}default:throw new X("SPA-AUTH_CLIENT-ON-IV01","Invalid hook.","The provided hook is invalid.")}}))}
/**
