...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@emotion/react/jsx-runtime'), require('@mui/material'), require('react'), require('zustand'), require('copy-to-clipboard')) :
    typeof define === 'function' && define.amd ? define(['exports', '@emotion/react/jsx-runtime', '@mui/material', 'react', 'zustand', 'copy-to-clipboard'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.JsonViewer = {}, global["@emotion/react/jsx-runtime"], global["@mui/material"], global.react, global.zustand, global["copy-to-clipboard"]));
    ...
    var createJsonViewerStore = function(props) {
        ...
        return zustand.create()(function(set, get) {
            return {
                // provided by user
    ...
    var JsonViewerStoreContext = react.createContext(undefined);
    JsonViewerStoreContext.Provider;
    var useJsonViewerStore = function(selector, equalityFn) {
        var store = react.useContext(JsonViewerStoreContext);
    ...
    ***************************************************************************** */
     ...
     */ function useClipboard() {
        ...
        var _useState = _sliced_to_array(react.useState(false), 2), copied = _useState[0], setCopied = _useState[1];
        var copyTimeout = react.useRef(null);
        var handleCopyResult = react.useCallback(function(value) {
    ...
    function useInspect(path, value, nestedIndex) {
        ...
        var setInspect = react.useCallback(function(apply) {
    ...
    var DataBox = function(props) {
        return /*#__PURE__*/ jsxRuntime.jsx(material.Box, _object_spread_props(_object_spread({
            component: "div"
        }, props), {
            sx: _object_spread({
    ...
    var BaseIcon = function(_param) {
        ...
        return /*#__PURE__*/ jsxRuntime.jsx(material.SvgIcon, _object_spread_props(_object_spread({}, props), {
    ...
    var CheckIcon = function(props) {
        return /*#__PURE__*/ jsxRuntime.jsx(BaseIcon, _object_spread({
            d: Check
        }, props));
    };
    ...
    var PreObjectType = function(props) {
        ...
        var isArray = react.useMemo(function() {
        ...
        var sizeOfValue = react.useMemo(function() {
        ...
        return /*#__PURE__*/ jsxRuntime.jsxs(material.Box, {
            ...
            children: [
                ...
                displayObjectSize && props.inspect && !isEmptyValue && /*#__PURE__*/ jsxRuntime.jsx(material.Box, {
                    component: "span",
                    sx: {
                        pl: 0.5,
                        fontStyle: "italic",
    ...
    var PostObjectType = function(props) {
        ...
        return /*#__PURE__*/ jsxRuntime.jsxs(material.Box, {
            ...
            children: [
                ...
                displayObjectSize && (isEmptyValue || !props.inspect) ? /*#__PURE__*/ jsxRuntime.jsx(material.Box, {
                    component: "span",
                    sx: {
                        pl: 0.5,
                        fontStyle: "italic",
    ...
    var ObjectType = function(props) {
        ...
        var isTrap = useIsCycleReference(props.path, props.value);
        var _useState = _sliced_to_array(react.useState(useJsonViewerStore(function(store) {
    ...
    var createTypeRegistryStore = function() {
        return zustand.createStore()(function(set) {
            return {
                registry: [],
    ...
    // @ts-expect-error we intentionally want to pass undefined to the context
    // See https://github.com/DefinitelyTyped/DefinitelyTyped/pull/24509#issuecomment-382213106
    var TypeRegistryStoreContext = /*#__PURE__*/ react.createContext(undefined);
    TypeRegistryStoreContext.Provider;
    var useTypeRegistryStore = function(selector, equalityFn) {
        var store = react.useContext(TypeRegistryStoreContext);
        return zustand.useStore(store, selector, equalityFn);
    };
    var objectType = {
        is: function(value) {
    ...
    function predefined() {
        ...
        registerType(_object_spread({
            ...
            var _useState = _sliced_to_array(react.useState(false), 2), showRest = _useState[0], setShowRest = _useState[1];
    ...
    var DataKeyPair = function(props) {
        ...
        var editable = react.useMemo(function() {
        ...
        var _useState = _sliced_to_array(react.useState(typeof value === "function" ? function() {
            return value;
        ...
        var isHover = react.useMemo(function() {
        ...
        var _useState1 = _sliced_to_array(react.useState(false), 2), editing = _useState1[0], setEditing = _useState1[1];
        ...
        var isHighlight = react.useMemo(function() {
        ...
        var highlightContainer = react.useRef();
        react.useEffect(function() {
        ...
        var actionIcons = react.useMemo(function() {
            if (editing) {
        ...
        var downstreamProps = react.useMemo(function() {
            return {
                path: path,
                inspect: inspect,
        ...
        return /*#__PURE__*/ jsxRuntime.jsxs(material.Box, {
            ...
            onMouseEnter: react.useCallback(function() {
            ...
            children: [
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ jsxRuntime.jsx(material.Box, {
                            ...
                            children: isRoot ? rootName !== false ? quotesOnKeys ? /*#__PURE__*/ jsxRuntime.jsxs(jsxRuntime.Fragment, {
                                ...
                                children: rootName
                            }) : null : KeyRenderer.when(downstreamProps) ? /*#__PURE__*/ jsxRuntime.jsx(KeyRenderer, _object_spread({}, downstreamProps)) : nestedIndex === undefined && (isNumberKey ? /*#__PURE__*/ jsxRuntime.jsx(material.Box, {
                                component: "span",
                                style: {
                        ...
                        PreComponent && /*#__PURE__*/ jsxRuntime.jsx(PreComponent, _object_spread({}, downstreamProps)),
                ...
                }) : Component ? /*#__PURE__*/ jsxRuntime.jsx(Component, _object_spread({}, downstreamProps)) : /*#__PURE__*/ jsxRuntime.jsx(material.Box, {
                    component: "span",
                    className: "data-value-fallback",
                    children: "fallback: ".concat(value)
                }),
                PostComponent && /*#__PURE__*/ jsxRuntime.jsx(PostComponent, _object_spread({}, downstreamProps)),
                isHover && expandable && !inspect && actionIcons,
    ...
    function useThemeDetector() {
        var _useState = _sliced_to_array(react.useState(false), 2), isDark = _useState[0], setIsDark = _useState[1];
        react.useEffect(function() {
     ...
     */ function useSetIfNotUndefinedEffect(key, value) {
        var setState = react.useContext(JsonViewerStoreContext).setState;
        react.useEffect(function() {
            if (value !== undefined) {
     ...
     */ var JsonViewerInner = function(props) {
        ...
        var themeCls = react.useMemo(function() {
        ...
        var onceRef = react.useRef(true);
        var predefinedTypes = react.useMemo(function() {
            return predefined();
        }, []);
    ...
    var JsonViewer = function JsonViewer(props) {
        ...
        var _props_theme;
        var themeType = react.useMemo(function() {
        ...
        var jsonViewerStore = react.useMemo(function() {
            return createJsonViewerStore(props);
        }, []);
        var typeRegistryStore = react.useMemo(function() {
        ...
        return /*#__PURE__*/ jsxRuntime.jsx(material.ThemeProvider, {
            ...
            children: /*#__PURE__*/ jsxRuntime.jsx(TypeRegistryStoreContext.Provider, {
                ...
                children: /*#__PURE__*/ jsxRuntime.jsx(JsonViewerStoreContext.Provider, {
                    ...
                    children: /*#__PURE__*/ jsxRuntime.jsx(JsonViewerInner, _object_spread({}, mixedProps))
                })
            })
        });
    };
